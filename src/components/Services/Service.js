...
const Service = ({ service }) => {
    return (
        <div className='card card-compact text-center w-72 border-2 border-transparent hover:border-primary shadow-primary shadow-sm rounded-lg p-5 transition duration-500 ease-in-out'>
